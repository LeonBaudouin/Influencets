...
const sin = (time: number, amount: number, offset: number) =>
  Math.sin(time * 0.03 + offset * Math.PI * 2) * amount
const cos = (time: number, amount: number, offset: number) =>
  Math.cos(time * 0.03 + offset * Math.PI * 2) * amount
